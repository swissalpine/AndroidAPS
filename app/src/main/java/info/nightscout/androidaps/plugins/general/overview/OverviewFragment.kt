...
//                    overview_apsmode_text?.setTextColor(resourceHelper.gc(R.color.ribbonTextWarning))
                ...
                loopPlugin.isDisconnected                                               -> {
                    ...
                    overview_apsmode_text?.text = "Disc. (" + DateUtil.age(loopPlugin.minutesToEndOfSuspend() * 60000L, true, resourceHelper) + ")"
...
//                    overview_apsmode_text?.setTextColor(resourceHelper.gc(R.color.ribbonTextCritical))
                ...
                loopPlugin.isEnabled() && loopPlugin.isSuspended                        -> {
                    ...
                    overview_apsmode_text?.text = "Susp. (" + DateUtil.age(loopPlugin.minutesToEndOfSuspend() * 60000L, true, resourceHelper) + ")"
