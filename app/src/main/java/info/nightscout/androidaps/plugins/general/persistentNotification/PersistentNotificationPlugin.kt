...
class PersistentNotificationPlugin @Inject constructor(
    ...
    private fun updateNotification() {
        ...
        if (profileFunction.isProfileValid("Notification")) {
            ...
            val line2aa = resourceHelper.gs(R.string.treatments_iob_label_string) + " " + DecimalFormatter.to1Decimal(bolusIob.iob + basalIob.basaliob) + "U. " + resourceHelper.gs(R.string.cob) + ": " + iobCobCalculatorPlugin.getCobInfo(false, "PersistentNotificationPlugin").generateCOBString() + "."
