...
val LightGeneralColors = GeneralColors(
    ...
    loopDisabled = Color(0xFF939393),        // red for disabled/paused loop
    loopDisconnected = Color(0xFFFF1313),    // gray for disconnected pump
    loopLgs = Color(0xFF00C03E),             // purple for LGS mode
...
val DarkGeneralColors = GeneralColors(
    ...
    loopClosed = Color(0xFF00FF00),          // green for closed loop
    loopOpened = Color(0xFF4983D7),          // blue for open loop
    loopDisabled = Color(0xFFFFFF00),        // red for disabled/paused loop
    loopDisconnected = Color(0xFFFF0000),    // gray for disconnected pump
    loopLgs = Color(0xFF00FF00),             // purple for LGS mode
    loopSuperBolus = Color(0xFFFB8C00),      // orange for super bolus
