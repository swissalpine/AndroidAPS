...
enum class UnitDoubleKey(
    ...
    ApsSmbThreshold("smbThreshold", 100.0, 72, 180, titleResId = R.string.pref_smb_threshold_title, summaryResId = R.string.smb_threshold_summary, sync = SyncSpec(SyncChannel.Cold, SyncDirection.Bidirectional))
}